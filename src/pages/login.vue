  ...
  <div style="text-align: center">
    <q-card style="margin-left:25%; margin: 10%; max-width: 70%">
      <div class="row">
        <div
          class="col"
          style="max-height: 20%; text-align: center; margin-left: 18%; margin-top: 5%"
        >
        ...
        <div class="col">
          ...
          <q-form class="q-gutter-md" style="max-width: 80%; margin-left: 12%">
            <q-input
              outlined
              v-model="username"
  ...
  methods: {
    getToken() {
      ...
      let config = {
        ...
        url: "https://back-fg.onrender.com/api/v1/api-token-auth/",
        headers: {
